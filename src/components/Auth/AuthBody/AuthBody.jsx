...
import "./auth-body.scss";
import AuthLogin from "../AuthLogin/AuthLogin";
import ButtonMainBig from "components/buttons/ButtonMainBig/ButtonMainBig";
...
const AuthBody = () => {
    ...
    return (
        <div className='auth-body'>
            <img className="auth-body__img" src={image} alt="" />
            <div className="auth-body__top">
                <div className="logo auth-body__logo">LOGO</div>
                <div className="auth-body__content">
                    <div className="user-bottom-head__triggers">
                        <button onClick={() => setState("login")} className={`user-bottom-head__trigger ${state === "login" ? "active" : ""}`}>
                        ...
                        <button onClick={() => setState("sing")}  className={`user-bottom-head__trigger ${state === "sing" ? "active" : ""}`}>
                        ...
                        <span style={{"left": state === "login" ? "0" : "50%"}} className="indicator-active"></span>
                    </div>

                    <div className="auth-body__form">
                        <AuthLogin/>
                        <button className="text-violet">Forgot Password?</button>
                    </div>
                </div>
            </div>
